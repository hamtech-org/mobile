...
export const AuthHero = () => {
  return (
    ...
    >
      <Text accessibilityRole="header" className="text-3xl font-extrabold tracking-tighter text-foreground">
        Hamtech
      </Text>
      <View className="flex-row items-start gap-2 self-stretch rounded-2xl bg-muted/90 px-3 py-3 dark:bg-muted/70">
        <Ionicons name="shield-checkmark-outline" size={14} color="hsl(var(--primary) / 1)" style={{ marginTop: 2 }} />
